...
//   const updateTaskName = (taskId, newTitle) => {
...
//                 <Card className="flex-1 w-[70%] bg-blue-50">
...
//                   Upcoming Tasks
//                 </h2>
//                 <TaskList tasks={upcomingTasks} toggleTaskDone={toggleTaskDone} updateTaskName={updateTaskName} />
//               </CardContent>
//             </Card>
...
//                   Completed Tasks
//                 </h2>
//                 <TaskList tasks={completedTasks} toggleTaskDone={toggleTaskDone} updateTaskName={updateTaskName} />
//               </CardContent>
//             </Card>
//           </div>
//         </div>
      ...
      <div className="container mx-auto py-8 px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="lg:w-[75%] mx-auto">
            ...
            <Card className="p-4 mb-6 w-full sm:w-[90%] bg-white shadow-md mx-auto rounded-lg">
              <CardContent className="flex flex-col gap-4">
                <h2 className="text-2xl font-semibold mx-auto text-gray-800">
                  <ListTodo className="inline mr-2" size={20} />
                  Add New Task
          ...
          <div>
            <div className="flex items-center w-full sm:w-[70%] gap-4 mb-6">
              <Input
                type="text"
                value={searchTerm}
                onChange={handleSearch}
            ...
            <Card className="p-4 mb-6 bg-white shadow-md rounded-lg w-full sm:w-[70%]">
              <CardContent>
                <h2 className="text-xl font-semibold text-gray-800 mb-4">
                  Upcoming Tasks
                </h2>
            ...
            <Card className="p-4 bg-white shadow-md rounded-lg w-full sm:w-[70%]">
              <CardContent>
                <h2 className="text-xl font-semibold text-gray-800 mb-4">
                  Completed Tasks
                </h2>
