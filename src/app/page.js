...
import { Search, Plus, Clipboard, CheckCircle ,listtodo } from 'lucide-react';
  ...
  return (
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className='md:w-[75%] mx-auto mt-10'>
          <Card className="p-4 mb-6 md:w-[90%] bg-white shadow-md rounded-lg">
